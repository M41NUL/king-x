...
try:
	...
	import rich except ImportError:
...
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1m𓊈𒆜𝐌𝐃 𝐌𝐀𝐈𝐍𝐔𝐋 𝐈𝐒𝐋𝐀𝐌𒆜𓊉꧂

\x1b[93;1m WhatsApp     \x1b[92;1m=>        \x1b[93;1m𓊈𒆜+8801308850528𒆜𓊉꧂

\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1m𓊈𒆜𝐌41𝐍𝐔𝐋𒆜𓊉꧂
...
def menu(): #Baloch
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UC2vSdMR8CU1UZsdNJK0Odtg")
...
def crack2(idf,pwv):
	...
	print('\r%s [𝐌𝐀𝐈𝐍𝐔𝐋] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
